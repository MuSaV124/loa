...
const APP_VERSION = process.env.LOA_SKILL_AUDIT_APP_VERSION || '5.15.6';
...
async function fetchCharacter(row) {
  ...
  const response = await fetch(url, { headers: { 'user-agent': 'LostArkCalculatorSkillCycleAudit/5.15.6' } });
